...
public class VistaJugador {
    ...
    //Guardamos la referencia a la ventana maestra para comunicarnos
    private VBox vista;             
    //El contenedor raíz de esta sección (una caja vertical)
    
    //Etiquetas (Labels) que cambiaremos dinámicamente durante el juego
    private Label jugadorLabel;     
    //Muestra el nombre
    private Label posicionLabel;    
    //Muestra el número de casilla
    private Label inventarioLabel;  
    //Muestra los objetos que posee
    private Label turnoLabel;       
    //Indica de quién es el turno actual
    private ImageView fotoPerfil;   
    //Imagen del pingüino que representa al jugador

    //CONSTRUCTOR
    //principal Recibe la instancia de la Vista principal (Dependency Injection)
    
    public VistaJugador(VistaJavaFX principal) {
        this.principal = principal; 
        //Asignamos la referencia
        crearVista();               
        //Ejecutamos el montaje visual
    }
    ...
    private void crearVista() {
        ...
        //Tamaño adecuado para el panel lateral
    ...
    //controladorTurnos El motor que sabe quién está jugando.
